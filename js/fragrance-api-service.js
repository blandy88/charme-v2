...
class FragranceAPIService {
  ...
  initializeComprehensiveDatabase() {
    const fragrances = [
      ...
      this.make("Uomo Extradose", "Valentino", "Woody Ambery Fougere", "men", "", ["spices", "lavandin", "vetiver", "guaiac wood", "amber accord", "vanilla"], 2025, "", "A deeper Born in Roma twist powered by extra vetiver, aromatic lavandin, warm spice, and an addictive amber-vanilla trail."),
      this.make("Donna Extradose", "Valentino", "Floral Ambery", "women", "", ["black currant", "rum accord", "jasmine", "vanilla"], 2025, "", "A richer Born in Roma Donna built around black currant, liquor-like rum facets, jasmine, and a plush vanilla overdose."),
      this.make("Cedar Chic", "Carolina Herrera", "Floral Woody Musk", "unisex", "", ["aldehydes", "bergamot", "orange blossom", "white musk", "cedarwood"], 2025, "Antoine Maisondieu", "A polished Carolina Herrera cedar scent inspired by a crisp white shirt, airy aldehydes, orange blossom, white musk, and cedarwood."),
      ...
      this.make("La Belle Paradise Garden", "Jean Paul Gaultier", "Floral Amber", "women", "", ["blue water lily", "iris", "lotus", "vanilla"], 2024, "", "A tropical Jean Paul Gaultier floral amber where aquatic blue lily and iris melt into a soft sensual vanilla base."),
      ...
      this.make("eLVes", "Louis Vuitton", "Oriental Floral", "women", "", ["rose", "lily of the valley", "patchouli", "ambergris"], 2025, "Jacques Cavallier Belletrud", "A luminous Louis Vuitton floral with velvety rose and a smoother, richer profile that feels like Pacific Chill's more opulent counterpart."),
      this.make("Rose Amira", "Guerlain", "Oriental Floral", "unisex", "", ["rose", "olibanum", "patchouli", "musk"], 2024, "Delphine Jelk", "A velvety Guerlain rose framed by incense, patchouli, and musk in a darker Absolus Allegoria style."),
      ...
      this.make("Power of You", "Giorgio Armani", "Fruity Floral Gourmand", "women", "", ["passion fruit", "frangipani", "vanilla"], 2026, "", "A ruby-toned Armani gourmand with tropical passion fruit, creamy frangipani, and warm vanilla."),
      this.make("Phantom in Red", "Rabanne", "Amber Woody", "men", "", ["saffron", "plum liquor", "bergamot", "lavender", "sage", "orange blossom", "amberwood", "benzoin", "oud", "tobacco"], 2025, "", "A bolder Rabanne Phantom with plum liquor, saffron, aromatic lavender, and a dark woody amber base touched by oud and tobacco."),
      ...
      this.make("Suprême Bouquet", "Yves Saint Laurent", "Amber Floral", "unisex", "", ["pink pepper", "bergamot", "tuberose", "ylang-ylang", "amber", "musk", "patchouli"], 2013, "Dominique Ropion", "An opulent YSL white floral from Le Vestiaire des Parfums where tuberose and ylang-ylang bloom over amber, musk, and patchouli."),
      ...
      this.make("Guilty Elixir Femme", "Gucci", "Amber Floral Woody", "women", "", ["bergamot", "mandora", "violet", "wisteria", "rose", "osmanthus", "vanilla absolute", "tonka bean", "patchouli"], 2023, "Quentin Bisch & Nathalie Cetto", "A richer Gucci Guilty pour Femme with violet, wisteria, osmanthus, vanilla absolute, and tonka over earthy patchouli."),
      ...
      this.make("Les Sables Roses", "Louis Vuitton", "Floral Oud", "unisex", "", ["rose", "oud", "ambergris", "black pepper", "saffron"], 2019, "Jacques Cavallier Belletrud", "A dramatic Louis Vuitton rose-oud composition that balances velvety petals with ambergris warmth and dark spice."),
      ...
      this.make("Hudson Valley", "Gissah", "Aromatic Green", "unisex", "", ["green apple", "bergamot", "mint", "vetiver", "cedar", "geranium", "musk", "amber", "sandalwood"], "", "", ""),
      ...
      this.make("Cristal Noir", "Versace", "Oriental Floral", "women", "", ["ginger", "cardamom", "pepper", "gardenia", "orange blossom", "coconut", "sandalwood", "amber", "musk"], 2004, "", "Versace's darkly glamorous oriental, spice-kissed ginger and cardamom over gardenia, coconut, and warm woods."),
      ...
      this.make("Stellar Times", "Louis Vuitton", "Amber Floral", "unisex", "", ["orange blossom", "white amber", "peru balsam", "vanilla"], 2021, "Jacques Cavallier Belletrud", "A warm, resinous extrait from the Les Extraits collection, orange blossom and white amber wrapped in Peru balsam and vanilla for a stellar golden glow."),
      ...
      this.make("Crystal Noir", "Versace", "Oriental Floral", "women", "", ["ginger", "cardamom", "pepper", "gardenia", "orange blossom", "coconut", "sandalwood", "amber", "musk"], 2004, "Unknown", "Versace's darkly glamorous oriental, spice-kissed ginger and cardamom over gardenia, coconut and warm woods."),
