...
class FragranceAPIService {
  ...
  initializeComprehensiveDatabase() {
    const fragrances = [
      ...
      this.make("Freedom Musk", "Kayali", "Floral Musk", "unisex", "https://fimgs.net/mdimg/perfume/375x500.118621.jpg", ["pear", "pink pepper", "freesia", "musk", "rose", "peony", "amber", "vanilla", "sandalwood"], "", "", ""),
      ...
      this.make("Uomo Extradose", "Valentino", "Woody Ambery Fougere", "men", "https://fimgs.net/mdimg/perfume/375x500.101383.jpg", ["spices", "lavandin", "vetiver", "guaiac wood", "amber accord", "vanilla"], 2025, "", "A deeper Born in Roma twist powered by extra vetiver, aromatic lavandin, warm spice, and an addictive amber-vanilla trail."),
      this.make("Donna Extradose", "Valentino", "Floral Ambery", "women", "https://fimgs.net/mdimg/perfume/375x500.101384.jpg", ["black currant", "rum accord", "jasmine", "vanilla"], 2025, "", "A richer Born in Roma Donna built around black currant, liquor-like rum facets, jasmine, and a plush vanilla overdose."),
      this.make("Cedar Chic", "Carolina Herrera", "Floral Woody Musk", "unisex", "https://fimgs.net/mdimg/perfume/375x500.109989.jpg", ["aldehydes", "bergamot", "orange blossom", "white musk", "cedarwood"], 2025, "Antoine Maisondieu", "A polished Carolina Herrera cedar scent inspired by a crisp white shirt, airy aldehydes, orange blossom, white musk, and cedarwood."),
      ...
      this.make("La Belle Paradise Garden", "Jean Paul Gaultier", "Floral Amber", "women", "https://fimgs.net/mdimg/perfume/375x500.88873.jpg", ["blue water lily", "iris", "lotus", "vanilla"], 2024, "", "A tropical Jean Paul Gaultier floral amber where aquatic blue lily and iris melt into a soft sensual vanilla base."),
      ...
      this.make("eLVes", "Louis Vuitton", "Oriental Floral", "women", "https://fimgs.net/mdimg/perfume/375x500.104087.jpg", ["rose", "lily of the valley", "patchouli", "ambergris"], 2025, "Jacques Cavallier Belletrud", "A luminous Louis Vuitton floral with velvety rose and a smoother, richer profile that feels like Pacific Chill's more opulent counterpart."),
      this.make("Rose Amira", "Guerlain", "Oriental Floral", "unisex", "https://fimgs.net/mdimg/perfume/375x500.90836.jpg", ["rose", "olibanum", "patchouli", "musk"], 2024, "Delphine Jelk", "A velvety Guerlain rose framed by incense, patchouli, and musk in a darker Absolus Allegoria style."),
      ...
      this.make("Power of You", "Giorgio Armani", "Fruity Floral Gourmand", "women", "https://fimgs.net/mdimg/perfume/375x500.121870.jpg", ["passion fruit", "frangipani", "vanilla"], 2026, "", "A ruby-toned Armani gourmand with tropical passion fruit, creamy frangipani, and warm vanilla."),
      this.make("Phantom in Red", "Rabanne", "Amber Woody", "men", "https://fimgs.net/mdimg/perfume/375x500.120953.jpg", ["saffron", "plum liquor", "bergamot", "lavender", "sage", "orange blossom", "amberwood", "benzoin", "oud", "tobacco"], 2025, "", "A bolder Rabanne Phantom with plum liquor, saffron, aromatic lavender, and a dark woody amber base touched by oud and tobacco."),
      ...
      this.make("Fantasmagoria", "Lattafa", "Oriental", "unisex", "https://fimgs.net/mdimg/perfume/375x500.116625.jpg", ["bergamot", "saffron", "pink pepper", "oud", "rose", "incense", "amber", "musk", "sandalwood"], "", "", ""),
      this.make("Supr\u00eame Bouquet", "Yves Saint Laurent", "Amber Floral", "unisex", "https://fimgs.net/mdimg/perfume/375x500.18369.jpg", ["pink pepper", "bergamot", "tuberose", "ylang-ylang", "amber", "musk", "patchouli"], 2013, "Dominique Ropion", "An opulent YSL white floral from Le Vestiaire des Parfums where tuberose and ylang-ylang bloom over amber, musk, and patchouli."),
      ...
      this.make("Oud Royal", "Guerlain", "Oriental", "unisex", "https://fimgs.net/mdimg/perfume/375x500.10884.jpg", ["oud", "saffron", "rose", "leather", "incense", "cardamom", "amber", "musk", "sandalwood"], "", "", ""),
      ...
      this.make("Les Sables Roses", "Louis Vuitton", "Floral Oud", "unisex", "https://fimgs.net/mdimg/perfume/375x500.55040.jpg", ["rose", "oud", "ambergris", "black pepper", "saffron"], 2019, "Jacques Cavallier Belletrud", "A dramatic Louis Vuitton rose-oud composition that balances velvety petals with ambergris warmth and dark spice."),
      this.make("Wanted Elixir", "Azzaro", "Oriental Spicy", "men", "https://fimgs.net/mdimg/perfume/375x500.102882.jpg", ["lavender", "cardamom", "bergamot", "leather", "vanilla", "tonka bean", "amber", "musk", "cedar"], "", "", ""),
      ...
      this.make("La Bomba", "Jean Paul Gaultier", "Floral Fruity", "women", "https://fimgs.net/mdimg/perfume/375x500.105931.jpg", ["strawberry", "raspberry", "pink pepper", "rose", "jasmine", "tuberose", "vanilla", "musk", "cedar"], "", "", ""),
      this.make("Ambre Samar", "Maison Crivelli", "Oriental Amber", "unisex", "https://fimgs.net/mdimg/perfume/375x500.105007.jpg", ["amber", "saffron", "bergamot", "rose", "oud", "incense", "musk", "sandalwood", "vanilla"], "", "", ""),
      ...
      this.make("Crush on Me", "Dolce & Gabbana", "Floral Fruity", "women", "https://fimgs.net/mdimg/perfume/375x500.66082.jpg", ["strawberry", "raspberry", "pink pepper", "rose", "jasmine", "peony", "musk", "vanilla", "cedar"], "", "", ""),
      ...
      this.make("Hudson Valley", "Gissah", "Aromatic Green", "unisex", "https://fimgs.net/mdimg/perfume/375x500.80052.jpg", ["green apple", "bergamot", "mint", "vetiver", "cedar", "geranium", "musk", "amber", "sandalwood"], "", "", ""),
      ...
      this.make("Cristal Noir", "Versace", "Oriental Floral", "women", "https://fimgs.net/mdimg/perfume/375x500.631.jpg", ["ginger", "cardamom", "pepper", "gardenia", "orange blossom", "coconut", "sandalwood", "amber", "musk"], 2004, "", "Versace's darkly glamorous oriental, spice-kissed ginger and cardamom over gardenia, coconut, and warm woods."),
      ...
      this.make("Manifesto Elixir", "Narciso Rodriguez", "Floral Musk", "women", "https://fimgs.net/mdimg/perfume/375x500.18785.jpg", ["rose", "bergamot", "pink pepper", "musk", "jasmine", "vanilla", "cedar", "amber", "tonka bean"], "", "", ""),
      ...
      this.make("Haltane", "Parfums de Marly", "Oriental Gourmand", "men", "https://fimgs.net/mdimg/perfume/375x500.70776.jpg", ["clary sage", "lavender", "bergamot", "saffron", "praline", "oud", "cedar"], 2021, "Mathieu Nardin", "A modern oud gourmand with aromatic herbs, saffron, praline, and refined woods."),
      ...
      this.make("Balayage", "Sospiro", "Oriental Floral", "women", "https://fimgs.net/mdimg/perfume/375x500.21279.jpg", ["peach", "bergamot", "pink pepper", "tuberose", "jasmine", "rose", "sandalwood", "vanilla", "musk"], 2014, "Chris Maurice", "A warm golden oriental floral with peach, tuberose, jasmine, and sandalwood."),
      ...
      this.make("1 Million Night", "Paco Rabanne", "Oriental Spicy", "men", "https://fimgs.net/mdimg/perfume/375x500.125545.jpg", ["cinnamon", "cardamom", "blood orange", "leather", "rose", "incense", "amber", "tonka bean", "oud"], 2023, "Christophe Raynaud", "A dark oriental spicy fragrance with cinnamon, leather, rose, and amber."),
      ...
      this.make("Crystal Noir", "Versace", "Oriental Floral", "women", "https://fimgs.net/mdimg/perfume/375x500.631.jpg", ["ginger", "cardamom", "pepper", "gardenia", "orange blossom", "coconut", "sandalwood", "amber", "musk"], 2004, "Unknown", "Versace's darkly glamorous oriental, spice-kissed ginger and cardamom over gardenia, coconut and warm woods."),
